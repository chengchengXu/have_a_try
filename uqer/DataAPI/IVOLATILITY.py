...
def DerIvGet(SecID, beginDate, endDate, optID = "", field = "", pandas = "1"):
    ...
    if hasattr(optID,'__iter__') and not isinstance(optID, str):
        if len(optID) > 100 and split_param is None:
            ...
            requestString.append(','.join([str(item) if not isinstance(item, unicode) else item for item in optID]))
    else:
        requestString.append(str(optID) if not isinstance(optID, unicode) else optID)
...
def DerIvHvGet(SecID, beginDate, endDate, period = "", field = "", pandas = "1"):
    ...
    if hasattr(period,'__iter__') and not isinstance(period, str):
        if len(period) > 100 and split_param is None:
            ...
            requestString.append(','.join([str(item) if not isinstance(item, unicode) else item for item in period]))
    else:
        requestString.append(str(period) if not isinstance(period, unicode) else period)
    requestString.append("&field=")
    if hasattr(field,'__iter__') and not isinstance(field, str):
        if len(field) > 100 and split_param is None:
            split_index = len(requestString)
...
def DerIvIvpDeltaGet(SecID, beginDate, endDate, period = "", delta = "", field = "", pandas = "1"):
    ...
    if hasattr(delta,'__iter__') and not isinstance(delta, str):
        if len(delta) > 100 and split_param is None:
            ...
            requestString.append(','.join([str(item) if not isinstance(item, unicode) else item for item in delta]))
    else:
        requestString.append(str(delta) if not isinstance(delta, unicode) else delta)
    requestString.append("&field=")
    if hasattr(field,'__iter__') and not isinstance(field, str):
        if len(field) > 100 and split_param is None:
            split_index = len(requestString)
...
def DerIvParamGet(SecID, beginDate, endDate, expDate = "", field = "", pandas = "1"):
    ...
    requestString.append("&endDate=%s"%(endDate))
    try:
        if isinstance(expDate,datetime):
            expDate = expDate.strftime('%Y%m%d')
        elif isinstance(expDate,list):
            tds=[]
            for td in expDate:
        ...
        if isinstance(expDate,(str,unicode)):
            tradeDates = expDate.split(',')
            tds=[]
    ...
    if hasattr(expDate,'__iter__') and not isinstance(expDate, str):
        if len(expDate) > 100 and split_param is None:
            ...
            requestString.append(','.join([str(item) if not isinstance(item, unicode) else item for item in expDate]))
    else:
        requestString.append(str(expDate) if not isinstance(expDate, unicode) else expDate)
    requestString.append("&field=")
    if hasattr(field,'__iter__') and not isinstance(field, str):
        if len(field) > 100 and split_param is None:
            split_index = len(requestString)
...
def DerIvSurfaceGet(SecID, beginDate, endDate, contractType = "", field = "", pandas = "1"):
    ...
    if hasattr(contractType,'__iter__') and not isinstance(contractType, str):
        if len(contractType) > 100 and split_param is None:
            ...
            requestString.append(','.join([str(item) if not isinstance(item, unicode) else item for item in contractType]))
    else:
        requestString.append(str(contractType) if not isinstance(contractType, unicode) else contractType)
    requestString.append("&field=")
    if hasattr(field,'__iter__') and not isinstance(field, str):
        if len(field) > 100 and split_param is None:
            split_index = len(requestString)
